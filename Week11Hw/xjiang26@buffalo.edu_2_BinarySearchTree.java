...
public class BinarySearchTree<E extends Comparable<E>> extends AbstractSet<E> {
  /**
   * Data version count which can be used to help our fail-fast implementation of the iterator.
   */
  ...
  protected class TreeIterator implements Iterator<E> {
     ...
     *
     * @throws IllegalStateException - if this TreeIterator's next() method was not called before this call, or if
     *           this TreeIterator's remove() method was called between the call to the next() method and this call.
     */
    @Override
    public void remove() {
