...
/**
 * This defines a few basic methods in a singly linked-based List. This is missing several methods needed for it to
 * actually work (but will appear in a second lecture *hint* *hint*), but has enough code for students to demonstrate
 * they understand how to traverse through a simple linked list.
 *
...
public class SingleLinkedList<E> extends AbstractList<E> {
  ...
  @Override
	  ...
	  public int size() {
	int ssize =0;
	for(Entry n =head;n!=null;n=n.next){
		ssize++;
	}
	return ssize;
  }
