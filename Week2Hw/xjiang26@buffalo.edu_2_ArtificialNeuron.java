...
public class ArtificialNeuron {
  ...
  /** Input values for this neuron. For purposes of this homework, we store these input values directly. */
  private double[] inputs;

  /**
   * Weights assigned to each of the inputs to this neuron. "Learning" typically occurs by
   */
